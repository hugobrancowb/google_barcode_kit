package com.google_barcode_kit;
...
/**
 * GoogleBarcodeKitPlugin
 */
public class GoogleBarcodeKitPlugin implements FlutterPlugin {
    /// The MethodChannel that will communicate between Flutter and native Android
    ///
    /// This local reference serves to register the plugin with the Flutter Engine and unregister it
    /// when the Flutter Engine is detached from the Activity
    private MethodChannel channel;
    private static String channelName = "google_barcode_kit";
